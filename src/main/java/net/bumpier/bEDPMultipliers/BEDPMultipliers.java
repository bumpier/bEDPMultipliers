...
public final class BEDPMultipliers extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        BMultiCommand commandExecutor = new BMultiCommand(this, multiplierManager, configManager, voucherManager);
        ...
        getServer().getPluginManager().registerEvents(new VoucherListener(multiplierManager, configManager, debugLogger), this);
